...
const (
	...
	defaultMaxFeeRate = eacutil.SatoshiPerBitcoin / 10
)
...
func (r FutureGetRawTransactionResult) Receive() (*eacutil.Tx, error) {
	...
	return eacutil.NewTx(&msgTx), nil
}
...
// transaction.
func (c *Client) GetRawTransaction(txHash *chainhash.Hash) (*eacutil.Tx, error) {
...
func (c *Client) CreateRawTransactionAsync(inputs []btcjson.TransactionInput,
	amounts map[eacutil.Address]eacutil.Amount, lockTime *int64) FutureCreateRawTransactionResult {
...
func (c *Client) CreateRawTransaction(inputs []btcjson.TransactionInput,
	amounts map[eacutil.Address]eacutil.Amount, lockTime *int64) (*wire.MsgTx, error) {
...
func (c *Client) SearchRawTransactionsAsync(address eacutil.Address, skip, count int, reverse bool, filterAddrs []string) FutureSearchRawTransactionsResult {
...
func (c *Client) SearchRawTransactions(address eacutil.Address, skip, count int, reverse bool, filterAddrs []string) ([]*wire.MsgTx, error) {
...
func (c *Client) SearchRawTransactionsVerboseAsync(address eacutil.Address, skip,
...
func (c *Client) SearchRawTransactionsVerbose(address eacutil.Address, skip,
