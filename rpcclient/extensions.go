...
//
// NOTE: This is a eacd extension.
func (c *Client) ListAddressTransactionsAsync(addresses []eacutil.Address, account string) FutureListAddressTransactionsResult {
...
//
// NOTE: This is a btcwallet extension.
func (c *Client) ListAddressTransactions(addresses []eacutil.Address, account string) ([]btcjson.ListTransactionsResult, error) {
