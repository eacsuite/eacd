...
import (
	...
	peerpkg "github.com/eacsuite/eacd/peer"
...
func (sm *SyncManager) handleBlockchainNotification(notification *blockchain.Notification) {
	...
	case blockchain.NTBlockAccepted:
		...
		block, ok := notification.Data.(*eacutil.Block)
		if !ok {
...
// processed.
func (sm *SyncManager) QueueTx(tx *eacutil.Tx, peer *peerpkg.Peer, done chan struct{}) {
...
// processed.
func (sm *SyncManager) QueueBlock(block *eacutil.Block, peer *peerpkg.Peer, done chan struct{}) {
...
// chain.
func (sm *SyncManager) ProcessBlock(block *eacutil.Block, flags blockchain.BehaviorFlags) (bool, error) {
