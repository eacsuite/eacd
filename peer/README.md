...
(http://godoc.org/github.com/eacsuite/eacd/peer)
...
```bash
$ go get -u github.com/eacsuite/eacd/peer
```

## Examples

* [New Outbound Peer Example]
  (https://godoc.org/github.com/eacsuite/eacd/peer#example-package--NewOutboundPeer)  
