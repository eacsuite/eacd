...
func GetBlockWeight(blk *eacutil.Block) int64 {
...
func GetTransactionWeight(tx *eacutil.Tx) int64 {
	msgTx := tx.MsgTx()
...
func GetSigOpCost(tx *eacutil.Tx, isCoinBaseTx bool, utxoView *UtxoViewpoint, bip16, segWit bool) (int, error) {
