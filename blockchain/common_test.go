...
// eacutil.Block.  This is largely borrowed from the test code in eacdb.
func loadBlocks(filename string) (blocks []*eacutil.Block, err error) {
	...
	for height := int64(1); err == nil; height++ {
		...
		block, err = eacutil.NewBlockFromBytes(rbytes)
		if err != nil {
			return
		}
