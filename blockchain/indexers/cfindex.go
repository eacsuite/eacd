...
func storeFilter(dbTx database.Tx, block *eacutil.Block, f *gcs.Filter,
...
func (idx *CfIndex) ConnectBlock(dbTx database.Tx, block *eacutil.Block,
...
func (idx *CfIndex) DisconnectBlock(dbTx database.Tx, block *eacutil.Block,
