...
func dbIndexConnectBlock(dbTx database.Tx, indexer Indexer, block *eacutil.Block,
...
func dbIndexDisconnectBlock(dbTx database.Tx, indexer Indexer, block *eacutil.Block,
	stxo []blockchain.SpentTxOut) error {
...
func dbFetchTx(dbTx database.Tx, hash *chainhash.Hash) (*wire.MsgTx, error) {
	...
	fmt.Printf("dbFetchTx --------- txBytes : %s\n", txBytes)
...
//
// This is part of the blockchain.IndexManager interface.
func (m *Manager) ConnectBlock(dbTx database.Tx, block *eacutil.Block,
...
//
// This is part of the blockchain.IndexManager interface.
func (m *Manager) DisconnectBlock(dbTx database.Tx, block *eacutil.Block,
	stxo []blockchain.SpentTxOut) error {
