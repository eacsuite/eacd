...
func (view *UtxoViewpoint) AddTxOut(tx *eacutil.Tx, txOutIdx uint32, blockHeight int32) {
...
func (view *UtxoViewpoint) AddTxOuts(tx *eacutil.Tx, blockHeight int32) {
...
func (view *UtxoViewpoint) connectTransaction(tx *eacutil.Tx, blockHeight int32, stxos *[]SpentTxOut) error {
...
func (view *UtxoViewpoint) connectTransactions(block *eacutil.Block, stxos *[]SpentTxOut) error {
...
func (view *UtxoViewpoint) disconnectTransactions(db database.DB, block *eacutil.Block, stxos []SpentTxOut) error {
...
// not modified.
func (view *UtxoViewpoint) fetchInputUtxos(db database.DB, block *eacutil.Block) error {
...
func (b *BlockChain) FetchUtxoView(tx *eacutil.Tx) (*UtxoViewpoint, error) {
