...
// is the zeroHash.
func BuildMerkleTreeStore(transactions []*eacutil.Tx, witness bool) []*chainhash.Hash {
...
func ExtractWitnessCommitment(tx *eacutil.Tx) ([]byte, bool) {
...
func ValidateWitnessCommitment(blk *eacutil.Block) error {
