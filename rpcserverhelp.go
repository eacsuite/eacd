...
var helpDescsEnUS = map[string]string{
	...
	"sendrawtransaction-maxfeerate":    "Used by earthcoind on or after v0.19.0",
	...
	// StopCmd help.
	"stop--synopsis": "Shutdown eacd.",
	"stop--result0":  "The string 'eacd stopping.'",
	...
	// NotifySpentCmd help.
	"notifyspent--synopsis": "Send a redeemingtx notification when a transaction spending an outpoint appears in mempool (if relayed to this eacd instance) and when such a transaction first appears in a newly-attached block.",
