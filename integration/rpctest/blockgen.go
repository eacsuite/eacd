...
func createCoinbaseTx(coinbaseScript []byte, nextBlockHeight int32,
	addr eacutil.Address, mineTo []wire.TxOut,
	net *chaincfg.Params) (*eacutil.Tx, error) {
...
func CreateBlock(prevBlock *eacutil.Block, inclusionTxs []*eacutil.Tx,
	blockVersion int32, blockTime time.Time, miningAddr eacutil.Address,
	mineTo []wire.TxOut, net *chaincfg.Params) (*eacutil.Block, error) {
	...
	blockTxns := []*eacutil.Tx{coinbaseTx}
	if inclusionTxs != nil {
	...
	utilBlock := eacutil.NewBlock(&block)
