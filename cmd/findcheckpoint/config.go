...
var (
	...
	defaultDataDir  = filepath.Join(eacdHomeDir, "data")
...
type config struct {
	DataDir        string `short:"b" long:"datadir" description:"Location of the eacd data directory"`
	DbType         string `long:"dbtype" description:"Database backend to use for the Block Chain"`
	UseGoOutput    bool   `short:"g" long:"gooutput" description:"Display the candidates using Go syntax that is ready to insert into the eacchain checkpoint list"`
...
// time of writing, eacd currently places blocks for testnet version 3 in the
