...
/*
eacd is a full-node Earthcoin implementation written in Go.

The default options are sane for most users.  This means eacd will work 'out of
...
parsed when eacd starts up.  By default, the configuration file is located at
~/.eacd/eacd.conf on POSIX-style operating systems and %LOCALAPPDATA%\eacd\eacd.conf
...
Application Options:
  ...
  -d, --debuglevel=           Logging level for all subsystems {trace, debug,
      ...
      --generate              Generate (mine) earthcoins using the CPU
      ...
      --miningaddr=           Add the specified payment address to the list of
                              ...
                              set
      --minrelaytxfee=        The minimum transaction fee in EAC/kB to be
      ...
      --rpcmaxwebsockets=     Max number of RPC websocket connections (default:
                              25)
      --rpcquirks             Mirror some JSON-RPC quirks of Earthcoin Core --
