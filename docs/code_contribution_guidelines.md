...
reason, the eacd suite has a formalized and rigorous development process which
...
- [Effective Go](http://golang.org/doc/effective_go.html) - The entire eacd
...
One of the major design goals of all core eacd packages is to aim for complete
...
commits](https://github.com/eacsuite/eacd/commits/master) for examples of
commit messages.
...
contributions.  This is how to get your changes into eacd.
...
Rejoice as you will now be listed as a [contributor](https://github.com/eacsuite/eacd/graphs/contributors)!
...
[ISC license](https://github.com/eacsuite/eacd/blob/master/LICENSE).  This is
the same license as all of the code in the eacd suite.
