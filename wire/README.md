...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/eacsuite/eacd/wire)
=======
...
[here](https://blog.conformal.com/btcwire-the-bitcoin-wire-protocol-package-from-eacd/).
...
```bash
$ go get -u github.com/eacsuite/eacd/wire
```
